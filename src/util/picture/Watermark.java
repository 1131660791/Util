...
public class Watermark {
		...
		static{
			strFWATERM = "yes,fh,多彩校园,fh,20,fh,1,fh,1";	//读取文字水印配置
			strIWATERM = "yes,fh,watermark.png,fh,1,fh,1";	//读取图片水印配置
		}
			...
			if(null != strIWATERM && !"".equals(strIWATERM)){
				...
				if(strIW.length == 4){
					if("yes".equals(strIW[0])){
						// 保存到的路径
						pressImage("E://文件名", imagePath, Integer.parseInt(strIW[2]), Integer.parseInt(strIW[3]));
					}
				}
			}
		  } 
